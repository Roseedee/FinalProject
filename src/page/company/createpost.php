<?php
    ...
    if(!isset($_SESSION['login_state']) || $_SESSION['user_type'] != 2) {
...
<header class="header">
    ...
    <div class="content content-create-post">
        ...
        <div class="form-input">
            <form action="php/insert-post.php" method="post">
                <span>เกี่ยวโพสต์</span>
                <div class="input-group">
                    <div class="input-section">
                        <input class="input" type="text" name="title-post" placeholder="หัวข้อ" >
                    </div>
                </div>
                <span>รายละเอียดเกี่ยวกับการฝึกงาน</span>
                <div class="input-group">
                    <div class="input-section">
                        <textarea class="input" type="text" name="details-post" rows="10" placeholder="รายละเอียดในการฝึกงาน"></textarea>
                    </div>
                </div>
                <span>สายงาน</span>
                <div class="input-group">
                ...
                <div class="input-submit" style="margin-top: 10px;">
                    <input type="submit" value="สร้างโพสต์" class="submit">
                </div>
            </form>
        </div>
